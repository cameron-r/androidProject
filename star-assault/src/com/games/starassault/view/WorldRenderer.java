package com.games.starassault.view;
...
import com.games.starassault.model.Block;
...
public class WorldRenderer {
	...
	public void setSize (int w, int h) {
		...
		Gdx.app.log(TAG, "in setSize, ppuX ="+ ppuX +", ppuY ="+ ppuY);
	}
	...
	private void drawBob() {
		...
		spriteBatch.draw(bobFrame, bob.getPosition().x * ppuX, bob.getPosition().y * ppuY,
